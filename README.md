...
If you're having issues with the packaged executable or using this tool in general, I recommend you read [my blog post on common issues when using auto-py-to-exe](https://nitratine.net/blog/post/issues-whko-KRing-auto-py-to-exe/). This post covers things you should know about packaging Python scripts and fixes for things that commonly go wrong.

### Making GitHub Issues
Before making an issue on GitHub, make sure you have read through the blog post above and tried to [debug your application](https://nitratine.net/blog/post/issues-whko-KRing-auto-py-to-exe/#debugging). Also please take some time to look through [older GitHub issues](https://github.com/brentvollebregt/auto-py-to-exe/issues?q=) to see if your issue has already been discussed.
...
![Converting](https://i.imgur.com/MjdONcC.png)"# PY_auto-py-to-exe" 
